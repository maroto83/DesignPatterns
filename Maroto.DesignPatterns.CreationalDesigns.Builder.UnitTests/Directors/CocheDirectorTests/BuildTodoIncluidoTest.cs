...
{
    public static class BuildTodoIncluidoTest
    {
        public class Given_A_CocheDirector_When_The_Builder_Is_CocheBuilder_And_BuildTodoIncluido
        ...
        public class Given_A_CocheDirector_When_The_Builder_Is_ManualDelCocheBuilder_And_BuildTodoIncluido
            : Given_When_Then_Test
        {
            private CocheDirector _sut;
            private Exception _exception;
